...
try:
  ...
  print("Error: matplotlib is not installed. Run `python -m pip install matplotlib` to install it.")
  exit(1)
try:
   import numpy as np
except ModuleNotFoundError:
  print("Error: numpy is not installed. Run `python -m pip install numpy` to install it.")
  exit(1)
